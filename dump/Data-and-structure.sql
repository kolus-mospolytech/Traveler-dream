...
/*!40000 ALTER TABLE `BusinessProcess`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `BusinessProcess`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `Client`
    DISABLE KEYS */;
INSERT INTO `Client`
VALUES (1, 'Вышегородцев С.И.', 'Вышегородцев Сергей Иванович', 'М', 1),
       (2, 'Смирнова Т.И.', 'Смирнова Татьяна Ивановка', 'Ж', 1),
       (3, 'Смотрила Е.В.', 'Смотрила Елена Владимировна', 'Ж', 1),
       (4, 'Гвоздев Р.Е.', 'Гвоздев Роман Евгеньевич', 'М', 1),
       (5, 'Шевченко Г.М.', 'Шевченко Георгий Михайлович', 'М', 1),
       (6, 'Ким Е.С.', 'Ким Евгений Славнович', 'М', 1),
       (7, 'Симонов В.Г.', 'Симонов Вячеслав Григорьевич', 'М', 1),
       (8, 'Довженко М.Г.', 'Довженко Михаил Григорьевич', 'М', 1),
       (9, 'Гусев В.Ф.', 'Гусев Владмир Федорович', 'М', 1),
       (10, 'Гусева Л.М.', 'Гусева Людмила Михайловна', 'Ж', 1);
/*!40000 ALTER TABLE `Client`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `ClientStatus`
    DISABLE KEYS */;
...
/*!40000 ALTER TABLE `InternationalPassport`
    DISABLE KEYS */;
INSERT INTO `InternationalPassport`
...
VALUES (1, 'Менеджер', NULL, 1),
       (2, 'Бухгалтер', NULL, 2),
       (3, 'Администратор', NULL, 3),
       (4, 'Агент', NULL, 4);
/*!40000 ALTER TABLE `Position`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `PreliminaryAgreement`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `PreliminaryAgreement`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `ProcessStatus`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `ProcessStatus`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 'Can add log entry', 1, 'add_logentry'),
       ...
       (25, 'Can add Чек', 7, 'add_bill'),
       (26, 'Can change Чек', 7, 'change_bill'),
       (27, 'Can delete Чек', 7, 'delete_bill'),
       (28, 'Can view Чек', 7, 'view_bill'),
       (29, 'Can add Город', 8, 'add_city'),
       (30, 'Can change Город', 8, 'change_city'),
       (31, 'Can delete Город', 8, 'delete_city'),
       (32, 'Can view Город', 8, 'view_city'),
       (33, 'Can add Клиент', 9, 'add_client'),
       (34, 'Can change Клиент', 9, 'change_client'),
       (35, 'Can delete Клиент', 9, 'delete_client'),
       (36, 'Can view Клиент', 9, 'view_client'),
       (37, 'Can add Статус Клиента', 10, 'add_clientstatus'),
       (38, 'Can change Статус Клиента', 10, 'change_clientstatus'),
       (39, 'Can delete Статус Клиента', 10, 'delete_clientstatus'),
       (40, 'Can view Статус Клиента', 10, 'view_clientstatus'),
       (41, 'Can add Страна', 11, 'add_country'),
       (42, 'Can change Страна', 11, 'change_country'),
       (43, 'Can delete Страна', 11, 'delete_country'),
       (44, 'Can view Страна', 11, 'view_country'),
       (45, 'Can add Валюта', 12, 'add_currency'),
       (46, 'Can change Валюта', 12, 'change_currency'),
       (47, 'Can delete Валюта', 12, 'delete_currency'),
       (48, 'Can view Валюта', 12, 'view_currency'),
       (49, 'Can add Сотрудник', 13, 'add_employee'),
       (50, 'Can change Сотрудник', 13, 'change_employee'),
       (51, 'Can delete Сотрудник', 13, 'delete_employee'),
       (52, 'Can view Сотрудник', 13, 'view_employee'),
       (53, 'Can add Тип Питания', 14, 'add_feedingtype'),
       (54, 'Can change Тип Питания', 14, 'change_feedingtype'),
       (55, 'Can delete Тип Питания', 14, 'delete_feedingtype'),
       (56, 'Can view Тип Питания', 14, 'view_feedingtype'),
       (57, 'Can add Тип Отеля', 15, 'add_hoteltype'),
       (58, 'Can change Тип Отеля', 15, 'change_hoteltype'),
       (59, 'Can delete Тип Отеля', 15, 'delete_hoteltype'),
       (60, 'Can view Тип Отеля', 15, 'view_hoteltype'),
       (61, 'Can add Организация', 16, 'add_organization'),
       (62, 'Can change Организация', 16, 'change_organization'),
       (63, 'Can delete Организация', 16, 'delete_organization'),
       (64, 'Can view Организация', 16, 'view_organization'),
       (65, 'Can add Предварительное Соглашение', 17, 'add_preliminaryagreement'),
       (66, 'Can change Предварительное Соглашение', 17, 'change_preliminaryagreement'),
       (67, 'Can delete Предварительное Соглашение', 17, 'delete_preliminaryagreement'),
       (68, 'Can view Предварительное Соглашение', 17, 'view_preliminaryagreement'),
       (69, 'Can add Статус Процесса', 18, 'add_processstatus'),
       (70, 'Can change Статус Процесса', 18, 'change_processstatus'),
       (71, 'Can delete Статус Процесса', 18, 'delete_processstatus'),
       (72, 'Can view Статус Процесса', 18, 'view_processstatus'),
       (73, 'Can add Тип Комнаты', 19, 'add_roomtype'),
       (74, 'Can change Тип Комнаты', 19, 'change_roomtype'),
       (75, 'Can delete Тип Комнаты', 19, 'delete_roomtype'),
       (76, 'Can view Тип Комнаты', 19, 'view_roomtype'),
       (77, 'Can add Должность', 20, 'add_position'),
       (78, 'Can change Должность', 20, 'change_position'),
       (79, 'Can delete Должность', 20, 'delete_position'),
       (80, 'Can view Должность', 20, 'view_position'),
       (81, 'Can add Отель', 21, 'add_hotel'),
       (82, 'Can change Отель', 21, 'change_hotel'),
       (83, 'Can delete Отель', 21, 'delete_hotel'),
       (84, 'Can view Отель', 21, 'view_hotel'),
       (85, 'Can add Договор', 22, 'add_contract'),
       (86, 'Can change Договор', 22, 'change_contract'),
       (87, 'Can delete Договор', 22, 'delete_contract'),
       (88, 'Can view Договор', 22, 'view_contract'),
       (89, 'Can add tour hotel', 23, 'add_tourhotel'),
       (90, 'Can change tour hotel', 23, 'change_tourhotel'),
       (91, 'Can delete tour hotel', 23, 'delete_tourhotel'),
       (92, 'Can view tour hotel', 23, 'view_tourhotel'),
       (93, 'Can add international passport', 24, 'add_internationalpassport'),
       (94, 'Can change international passport', 24, 'change_internationalpassport'),
       (95, 'Can delete international passport', 24, 'delete_internationalpassport'),
       (96, 'Can view international passport', 24, 'view_internationalpassport'),
       (97, 'Can add Бизнес процесс', 25, 'add_businessprocess'),
       (98, 'Can change Бизнес процесс', 25, 'change_businessprocess'),
       (99, 'Can delete Бизнес процесс', 25, 'delete_businessprocess'),
       (100, 'Can view Бизнес процесс', 25, 'view_businessprocess'),
       (101, 'Can add Турист', 26, 'add_tourist'),
       (102, 'Can change Турист', 26, 'change_tourist'),
       (103, 'Can delete Турист', 26, 'delete_tourist'),
       (104, 'Can view Турист', 26, 'view_tourist');
/*!40000 ALTER TABLE `auth_permission`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 'pbkdf2_sha256$260000$RHr18lS4HR3za18RlCptuR$UDVuEULodNmG57CfdfHFEZno9HllmwaUOdVVf8GPWXo=',
        '2021-11-29 08:55:17.583041', 1, 'root', '', '', '', 1, 1, '2021-11-29 08:36:02.377304'),
       (3, 'UN2Lv9bW', NULL, 0, 'ZEwTY6zA', '', '', '', 0, 1, '2021-11-29 11:45:11.000000'),
       (4, 'b9zJc3Np', NULL, 0, 'x53wLVmQ', '', '', '', 0, 1, '2021-11-29 11:45:11.000000'),
       (5, 'Yf8UGjbZ', NULL, 0, 'tVM3j5Bg', '', '', '', 0, 1, '2021-11-29 11:45:11.000000'),
       (6, 'gmGx9vEN', NULL, 0, 'D9SMea4d', '', '', '', 0, 1, '2021-11-29 11:45:11.000000'),
       (7, 'yCzBYM4x', NULL, 0, 'CtMd7p2P', '', '', '', 0, 1, '2021-11-29 11:45:11.000000'),
       (8, 'rbe4YL2B', NULL, 0, 'nPszc6Wh', '', '', '', 0, 1, '2021-11-29 11:45:11.000000'),
       (9, 'Hjm6pZ3F', NULL, 0, 'FmfbC7N9', '', '', '', 0, 1, '2021-11-29 11:45:11.000000'),
       (10, 'tyM7Wswa', NULL, 0, 'uC38vsAQ', '', '', '', 0, 1, '2021-11-29 11:45:11.000000'),
       (11, 'cpnZg2Tu', NULL, 0, 'MAuUQ4sk', '', '', '', 0, 1, '2021-11-29 11:45:11.000000'),
       (12, 'gx5qV86B', NULL, 0, 'rz7tQsWF', '', '', '', 0, 1, '2021-11-29 11:45:11.000000'),
       (13, 'UNkRh4z5', NULL, 0, 'DUSKm5Mf', '', '', '', 0, 1, '2021-11-29 11:45:11.000000'),
       (14, 'QeuSB7dj', NULL, 0, 'nMTQDv9k', '', '', '', 0, 1, '2021-11-29 11:45:11.000000'),
       (15, 'wGku3sD6', NULL, 0, 'Jnj5XKP7', '', '', '', 0, 1, '2021-11-29 11:45:11.000000'),
       (16, 'fw4KU6Bq', NULL, 0, 'RANd4kcx', '', '', '', 0, 1, '2021-11-29 11:45:11.000000'),
       (17, 'nY59xAwc', NULL, 0, 'vD8MJdAX', '', '', '', 0, 1, '2021-11-29 11:45:11.000000'),
       (18, 'TqZAD62N', NULL, 0, 'UGP9v6hR', '', '', '', 0, 1, '2021-11-29 11:45:11.000000');
/*!40000 ALTER TABLE `auth_user`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, '2021-11-29 08:41:32.991021', '2', 'roblox', 2, '[{\"changed\": {\"fields\": [\"password\"]}}]', 4, 1);
/*!40000 ALTER TABLE `django_admin_log`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 'admin', 'logentry'),
       ...
       (21, 'db', 'hotel'),
       (15, 'db', 'hoteltype'),
       (24, 'db', 'internationalpassport'),
       (16, 'db', 'organization'),
       (20, 'db', 'position'),
       (17, 'db', 'preliminaryagreement'),
       (18, 'db', 'processstatus'),
       (19, 'db', 'roomtype'),
       (23, 'db', 'tourhotel'),
       (26, 'db', 'tourist'),
...
VALUES (1, 'contenttypes', '0001_initial', '2021-11-29 08:01:04.976610'),
       (2, 'auth', '0001_initial', '2021-11-29 08:01:05.451756'),
       (3, 'admin', '0001_initial', '2021-11-29 08:01:05.561890'),
       (4, 'admin', '0002_logentry_remove_auto_add', '2021-11-29 08:01:05.569782'),
       (5, 'admin', '0003_logentry_add_action_flag_choices', '2021-11-29 08:01:05.577770'),
       (6, 'contenttypes', '0002_remove_content_type_name', '2021-11-29 08:01:05.654477'),
       (7, 'auth', '0002_alter_permission_name_max_length', '2021-11-29 08:01:05.700899'),
       (8, 'auth', '0003_alter_user_email_max_length', '2021-11-29 08:01:05.718688'),
       (9, 'auth', '0004_alter_user_username_opts', '2021-11-29 08:01:05.725755'),
       (10, 'auth', '0005_alter_user_last_login_null', '2021-11-29 08:01:05.767425'),
       (11, 'auth', '0006_require_contenttypes_0002', '2021-11-29 08:01:05.772017'),
       (12, 'auth', '0007_alter_validators_add_error_messages', '2021-11-29 08:01:05.778818'),
       (13, 'auth', '0008_alter_user_username_max_length', '2021-11-29 08:01:05.824658'),
       (14, 'auth', '0009_alter_user_last_name_max_length', '2021-11-29 08:01:05.872137'),
       (15, 'auth', '0010_alter_group_name_max_length', '2021-11-29 08:01:05.887993'),
       (16, 'auth', '0011_update_proxy_permissions', '2021-11-29 08:01:05.895274'),
       (17, 'auth', '0012_alter_user_first_name_max_length', '2021-11-29 08:01:05.942619'),
       (18, 'sessions', '0001_initial', '2021-11-29 08:01:05.974999'),
       (19, 'db', '0001_initial', '2021-11-29 08:01:28.287876');
/*!40000 ALTER TABLE `django_migrations`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES ('a28w6qj6l6b3tapl8adu8da7m8gwylcq',
        '.eJxVjMsOwiAQAP-FsyHyWKAevfsNze4CUjWQlPZk_HdD0oNeZybzFjPuW5n3ntZ5ieIilDj9MkJ-pjpEfGC9N8mtbutCciTysF3eWkyv69H-DQr2MrbJZbIMFgE0BUQ9MXOKTMYRYlDZ5QBowTMamPzZZ6VNdNYFHY334vMFCf04NA:1mrcRR:75zhfjb7Hx_jfp_1Q8l_uplQ0AGi8FE7LY76tVeQQj8',
