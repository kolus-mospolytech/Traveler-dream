...
from .models import Client, Employee, InternationalPassport
...
class CreateEmployee(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'photo': forms.FileInput(attrs={'required': 'required'})
        }
        fields = ['username', 'password', 'name', 'full_name', 'is_staff', 'is_active',
...
class EditEmployee(ModelForm):
    class Meta:
        ...
        fields = ['name', 'full_name',
                  'birth_date', 'sex', 'organization', 'photo']
    # class Meta:
    #     model = Employee
    #     widgets = {
    #         'birth_date': forms.DateInput(format='%Y-%m-%d',
    ...
    #                                              'type': 'date'}),
    #     }
    #     fields = ['name', 'full_name', 'birth_date', 'photo']


# class DeleteEmployee(ModelForm):
#     class Meta:
#         model = Employee
